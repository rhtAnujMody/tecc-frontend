...
export default function DashboardHome({
  ...
  const bannerItems = [
    {
      header:
        "Ignite Your Potential, Achieve Greatness: Start Learning with Our Courses",
      color: "#3498DB",
    },
    {
      header: "Your Gateway to Unlimited Learning Resources",
      color: "#7F56D9",
    },
    {
      header: "Real Stories, Real Impact: In-Depth Case Studies Await",
      color: "#F2A000",
    },
  ];
